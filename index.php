	...
	function runPhpScript(variable) {
		...
		xhr.onreadystatechange = function() {
			if (xhr.readyState === 4 && xhr.status === 200) {
				...
				alert("Response from PHP: " + responseData);
			}
		};

		xhr.send("action=callPhpFunction&param1=" + param1 + "&param2=" + param2);
	}
			...
			<form action="#">
				<div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
					<div class="sm:col-span-2">
						<label for="country" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Name</label>
